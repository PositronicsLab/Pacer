...
boost::shared_ptr<Pacer::Controller> ctrl(ctrl_weak_ptr);
  ...
  std::ostringstream s;
 std::string line;
  std::vector<std::string> var_names={"lenF1","lenF2","FfootLen","lenH1","lenH2","HfootLen","base_size_length","base_size_width","base_size_height","FlinkRad","HlinkRad","FfootRad","HfootRad","massF1","massF2","massF3","massH1","massH2","massH3","massBase"};
