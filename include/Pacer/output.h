...
static void OUTLOG(const boost::shared_ptr<Ravelin::Pose3d>& P, std::string name,TLogLevel LL){
...
static void OUTLOG(const boost::shared_ptr<const Ravelin::Pose3d>& P, std::string name,TLogLevel LL){
