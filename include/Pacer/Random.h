...
public:
  ...
  static void parse_distribution(const std::string& parameters,const boost::shared_ptr<Pacer::Controller> ctrl,std::vector<boost::shared_ptr<Generator> >& generator){
